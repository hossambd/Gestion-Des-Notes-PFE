...
use App\Http\Controllers\Backend\Setup\ModuleController;
use App\Http\Controllers\Backend\Setup\StudentTeacherController;
use App\Http\Controllers\Backend\Setup\SemestreController;
use App\Http\Controllers\Backend\Setup\GroupeController;
use App\Http\Controllers\Backend\Setup\AnneeController;
use App\Http\Controllers\Backend\Setup\FeeCategoryController;
use App\Http\Controllers\Backend\Setup\FeeAmountControllere;
use App\Http\Controllers\Backend\Setup\ExamTypeController;
use App\Http\Controllers\Backend\Setup\ElementController;
use App\Http\Controllers\Backend\Setup\AssignModuleController;
use App\Http\Controllers\Backend\Setup\AssignSubjectController;
use App\Http\Controllers\Backend\Setup\AssignTeacherController;
use App\Http\Controllers\Backend\Setup\AssignStudentController;
...
Route::get('/student/year/class/wise', [ProfileController::class, 'StudentClassYearWise'])->name('profile.student.year.class.wise');
...
Route::get('student/class/view', [ModuleController::class, 'ViewStudent'])->name('student.class.view');

Route::get('student/class/add', [ModuleController::class, 'StudentClassAdd'])->name('student.class.add');

Route::post('student/class/store', [ModuleController::class, 'StudentClassStore'])->name('store.student.class');

Route::get('student/class/edit/{id}', [ModuleController::class, 'StudentClassEdit'])->name('student.class.edit');

Route::post('student/class/update/{id}', [ModuleController::class, 'StudentClassUpdate'])->name('update.student.class');

Route::get('student/class/delete/{id}', [ModuleController::class, 'StudentClassDelete'])->name('student.class.delete');

// Student Teacher Routes 

Route::get('student/teacher/view', [StudentTeacherController::class, 'ViewStudent'])->name('student.teacher.view');

Route::get('student/teacher/add', [StudentTeacherController::class, 'StudentTeacherAdd'])->name('student.teacher.add');

Route::post('student/teacher/store', [StudentTeacherController::class, 'StudentTeacherStore'])->name('store.student.teacher');

Route::get('student/teacher/edit/{id}', [StudentTeacherController::class, 'StudentTeacherEdit'])->name('student.teacher.edit');

Route::post('student/teacher/update/{id}', [StudentTeacherController::class, 'StudentTeacherUpdate'])->name('update.student.teacher');

Route::get('student/teacher/delete/{id}', [StudentTeacherController::class, 'StudentTeacherDelete'])->name('student.teacher.delete');

// Student Year Routes 

Route::get('student/year/view', [SemestreController::class, 'ViewYear'])->name('student.year.view');

Route::get('student/year/add', [SemestreController::class, 'StudentYearAdd'])->name('student.year.add');

Route::post('student/year/store', [SemestreController::class, 'StudentYearStore'])->name('store.student.year');

Route::get('student/year/edit/{id}', [SemestreController::class, 'StudentYearEdit'])->name('student.year.edit');

Route::post('student/year/update/{id}', [SemestreController::class, 'StudentYearUpdate'])->name('update.student.year');

Route::get('student/year/delete/{id}', [SemestreController::class, 'StudentYearDelete'])->name('student.year.delete');


// Student Group Routes 

Route::get('student/group/view', [GroupeController::class, 'ViewGroup'])->name('student.group.view');

Route::get('student/group/add', [GroupeController::class, 'StudentGroupAdd'])->name('student.group.add');

Route::post('student/group/store', [GroupeController::class, 'StudentGroupStore'])->name('store.student.group');

Route::get('student/group/edit/{id}', [GroupeController::class, 'StudentGroupEdit'])->name('student.group.edit');

Route::post('student/group/update/{id}', [GroupeController::class, 'StudentGroupUpdate'])->name('update.student.group');

Route::get('student/group/delete/{id}', [GroupeController::class, 'StudentGroupDelete'])->name('student.group.delete');

// Student Shift Routes 

Route::get('student/shift/view', [AnneeController::class, 'ViewShift'])->name('student.shift.view');

Route::get('student/shift/add', [AnneeController::class, 'StudentShiftAdd'])->name('student.shift.add');

Route::post('student/shift/store', [AnneeController::class, 'StudentShiftStore'])->name('store.student.shift');

Route::get('student/shift/edit/{id}', [AnneeController::class, 'StudentShiftEdit'])->name('student.shift.edit');

Route::post('student/shift/update/{id}', [AnneeController::class, 'StudentShiftUpdate'])->name('update.student.shift');

Route::get('student/shift/delete/{id}', [AnneeController::class, 'StudentShiftDelete'])->name('student.shift.delete');
...
Route::get('school/subject/view', [ElementController::class, 'ViewSubject'])->name('school.subject.view');

Route::get('school/subject/add', [ElementController::class, 'SubjectAdd'])->name('school.subject.add');

Route::post('school/subject/store', [ElementController::class, 'SubjectStore'])->name('store.school.subject');

Route::get('school/subject/edit/{id}', [ElementController::class, 'SubjectEdit'])->name('school.subject.edit');

Route::post('school/subject/update/{id}', [ElementController::class, 'SubjectUpdate'])->name('update.school.subject');

Route::get('school/subject/delete/{id}', [ElementController::class, 'SubjectDelete'])->name('school.subject.delete');

// Assign Class Routes 

Route::get('assign/class/view', [AssignModuleController::class, 'ViewAssignClass'])->name('assign.class.view');

Route::get('assign/class/add', [AssignModuleController::class, 'AddAssignClass'])->name('assign.class.add');

Route::post('assign/class/store', [AssignModuleController::class, 'StoreAssignClass'])->name('store.assign.class');

Route::get('assign/class/edit/{semestre_id}', [AssignModuleController::class, 'EditAssignClass'])->name('assign.class.edit');

Route::post('assign/class/update/{semestre_id}', [AssignModuleController::class, 'UpdateAssignClass'])->name('update.assign.class');

Route::get('assign/class/details/{semestre_id}', [AssignModuleController::class, 'DetailsAssignClass'])->name('assign.class.details');
...
Route::get('assign/subject/edit/{semestre_id}/{module_id}', [AssignSubjectController::class, 'EditAssignSubject'])->name('assign.subject.edit');

Route::post('assign/subject/update/{module_id}', [AssignSubjectController::class, 'UpdateAssignSubject'])->name('update.assign.subject');

Route::get('assign/subject/details/{module_id}', [AssignSubjectController::class, 'DetailsAssignSubject'])->name('assign.subject.details');

// Assign Teacher Routes 

Route::get('assign/teacher/view', [AssignTeacherController::class, 'ViewAssignTeacher'])->name('assign.teacher.view');

Route::get('assign/teacher/add', [AssignTeacherController::class, 'AddAssignTeacher'])->name('assign.teacher.add');

Route::post('assign/teacher/store', [AssignTeacherController::class, 'StoreAssignTeacher'])->name('store.assign.teacher');

Route::get('assign/teacher/edit/{teacher_id}', [AssignTeacherController::class, 'EditAssignTeacher'])->name('assign.teacher.edit');

Route::post('assign/teacher/update/{teacher_id}', [AssignTeacherController::class, 'UpdateAssignTeacher'])->name('update.assign.teacher');

Route::get('assign/teacher/details/{teacher_id}', [AssignTeacherController::class, 'DetailsAssignTeacher'])->name('assign.teacher.details');

// Assign Student Routes 

Route::get('assign/student/view', [AssignStudentController::class, 'ViewAssignStudent'])->name('assign.student.view');

Route::get('assign/student/add', [AssignStudentController::class, 'AddAssignStudent'])->name('assign.student.add');

Route::post('assign/student/store', [AssignStudentController::class, 'StoreAssignStudent'])->name('store.assign.student');

Route::get('assign/student/edit/{student_id}', [AssignStudentController::class, 'EditAssignStudent'])->name('assign.student.edit');

Route::post('assign/student/update/{student_id}', [AssignStudentController::class, 'UpdateAssignStudent'])->name('update.assign.student');

Route::get('assign/student/details/{student_id}', [AssignStudentController::class, 'DetailsAssignStudent'])->name('assign.student.details');
...
Route::get('marks/getsubjectteacher', [DefaultController::class, 'GetSubjectTeacher'])->name('marks.getsubjectteacher');

Route::get('marks/getclass', [DefaultController::class, 'GetClass'])->name('marks.getclass');
...
Route::get('marksheet/generate/details', [MarkSheetController::class, 'MarkSheetDetails'])->name('report.marksheet.details');
Route::get('student/result/details', [ResultReportController::class, 'StudentResultDetails'])->name('report.student.result.details');
