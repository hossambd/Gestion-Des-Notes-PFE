...
<div class="box bb-3 border-warning">
				  <div class="box-header">
					<h4 class="box-title"> Impression :<strong>Relevé de notes PDF</strong></h4>
				  </div>
  ...
  <div class="row">  <!-- start 1st row -->
   ...
   <img src="{{ url('upload/logoena-der.png') }}" style="width: 120px; height: 100px;">			
  		</div>
        ...
        <div class="col-md-2 text-center">
  		...
  		<div class="col-md-4 text-center" style="float: left;">
  			<h4><strong>ENA Agadir</strong></h4>
  			<h6><strong>Ecole d'architecture d'Agadir</strong></h6>
  			<h5><strong><u><i>Relevé de note</i></u></strong></h5>
  ...
  <p style="text-align: right;"><u><i>Imprimé le: </i>{{ date('d M Y') }} </u></p>
...
@php
	$assign_student = App\Models\AssignStudent::where('annee_id',$allMarks['0']->annee_id)->where('semestre_id',$allMarks['0']->semestre_id)->first();
@endphp
...
<tr>
	...
	<td width="50%">{{ $allMarks['0']['semestre']['name'] }}</td>
</tr>


<tr>
	<td width="50%">Session</td>
	<td width="50%">{{ $allMarks['0']['annee']['name'] }}</td>
</tr>
...
@php
  ...
  $total_subject = App\Models\StudentMarks::where('annee_id',$mark->annee_id)->where('semestre_id',$mark->semestre_id)->where('exam_type_id',$mark->exam_type_id)->where('student_id',$mark->student_id)->get()->count();
@endphp
<tr>
...
<div class="row"> <!--  6th row start -->
  ...
  <hr style="border: solid 1px; widows: 60%; color: #ffffff; margin-bottom: -3px;">
    ...
    <div class="col-md-4">
 <hr style="border: solid 1px; widows: 60%; color: #ffffff; margin-bottom: -3px;">
    <div class="text-center">Directeur</div>
  </div>
