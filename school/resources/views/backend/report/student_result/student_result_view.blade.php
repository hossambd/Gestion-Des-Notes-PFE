...
<div class="box bb-3 border-warning">
				  <div class="box-header">
					<h4 class="box-title">Gestion <strong>PV de classe</strong></h4>
				  </div>
...
<div class="col-md-3">
 ...
 <select name="exam_type_id" id="exam_type_id"  required="" class="form-control">
  ...
  <input type="submit" class="btn btn-rounded btn-primary" value="Imprimer" formaction="{{url('reports/student/result/details')}}">
