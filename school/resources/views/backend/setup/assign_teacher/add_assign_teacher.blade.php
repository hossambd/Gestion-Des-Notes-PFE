...
<section class="content">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Assigner Enseignant</h4>
	 ...
	 <form method="post" action="{{ route('store.assign.teacher') }}">
	 	@csrf
		 <div class="row">
     	<div class="col-md-4">
   ...
   <div class="form-group">
	...
	<div class="controls">
	 <select name="teacher_id" required="" class="form-control">
		<option value="" selected="" disabled="">Choisir Enseignant</option>
		@foreach($teachers as $teacher)
		<option value="{{ $teacher->id }}">{{ $teacher->nomfr }}</option>
		@endforeach	 
		</select>
	 </div>
          </div> <!-- // end form group -->
