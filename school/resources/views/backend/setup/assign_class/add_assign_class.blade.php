...
<section class="content">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Assigner module</h4>
	 ...
	 <form method="post" action="{{ route('store.assign.class') }}">
	 	@csrf
					  <div class="row">
						<div class="col-12">
						<div class="add_item">
 ...
 <span class="btn btn-success addeventmore"><i class="fa fa-plus-circle"></i> </span> 
  <span class="btn btn-danger removeeventmore" hidden="hidden"><i class="fa fa-minus-circle"></i> </span> 
     	</div><!-- End col-md-5 -->
