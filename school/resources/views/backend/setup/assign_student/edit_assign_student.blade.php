...
<section class="content">
 ...
 <form method="post" action="{{ route('update.assign.student',$editData[0]->student_id) }}">
	 	@csrf
					  <div class="row">
						<div class="col-12">
						<div class="add_item">
	...
	<h5>Nom Etudiant <span class="text-danger">*</span></h5>
	<div class="controls">
	 <input type ="text" name="student_id"  disabled class="form-control"
	 value ="{{ $editData['0']['student']['nomfr'].' '.$editData['0']['student']['prenomfr'] }} ">
	 </div>
          </div> <!-- // end form group -->
