...
<div class="controls">
<input type="text" name="name" class="form-control" required="" value="{{ $editData['student']['nomfr'] }}"> 
</div>		 
</div>
...
<div class="controls">
<input type="text" name="address" class="form-control" required="" value="{{ $editData['student']['adress'] }}"> 
</div>		 
</div>
...
<div class="controls">
<input type="date" name="dob" class="form-control" required="" value="{{ $editData['student']['dateN'] }}"> 
</div>		 
</div>
 ...
 <div class="col-md-3">
	...
	<div class="form-group">
		...
		<div class="controls">
	 <input type="text" name="lieuN" class="form-control" required="" value="{{ $editData['student']['lieuN'] }}"> 
	  </div>		 
	  </div>
...
<div class="controls">
<input type="text" name="sessionBac" class="form-control" required="" value="{{ $editData['student']['sessionBac'] }}"> 
</div>		 
</div>
...
<div class="controls">
<input type="text" name="anneeBac" class="form-control" required="" value="{{ $editData['student']['anneeBac'] }}"> 
</div>		 
</div>
...
<div class="controls">
<input type="text" name="filiere" class="form-control" required="" value="{{ $editData['student']['filiere'] }}" > 
</div>		 
</div>
