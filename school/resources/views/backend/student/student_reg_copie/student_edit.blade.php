...
<section class="content">
	...
	<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Nom Père <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="col-md-4">
 		 ...
 		 <div class="form-group">
		<h5>Nom Mère <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="col-md-4">
	 ...
	 <select name="gender" id="gender" required="" class="form-control">
			<option value="" selected="" disabled="">Choisir genre</option>
...
<div class="col-md-4">
 ...
 <option value="Autre"{{ ($editData['student']['religion'] == 'Autre')? 'selected':'' }}>Autre</option>	 
		</select>
	  </div>		 
	  </div>
...
<div class="col-md-4">
 ...
 <option value="{{ $year->id }}" {{ ($editData->semestre_id == $year->id)? "selected":"" }}  >{{ $year->name }}</option>
		 	@endforeach
